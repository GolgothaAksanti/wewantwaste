...
export const WasteAddress = () => {
  ...
  return (
    <div className="mx-auto my-20 whitespace-nowrap space-y-4 px-4 md:px-0 md:w-2/3 xl:w-1/3 lg:space-y-8">
      <div className="space-y-4">
        <h1 className="text-5xl lg:text-7xl uppercase text-center">
          Skip Hire
        </h1>
        <p className=" text-xl lg:text-2xl capitalize text-center">
          with a difference
        </p>
      </div>
      ...
      <div className="w-full transition-transform duration-300 space-y-2 lg:space-y-4">
        <div className="p-3 relative bg-zinc-900 border-zinc-800 flex w-full items-center gap-4 border rounded-lg">
          ...
          {loading && <Loader className="animate-spin absolute z-20 right-4" />}
